...
Run:
    python -m backend.ml.drinks.training.wine.build_wine_split
    python -m backend.ml.drinks.training.wine.build_wine_split --k 5
"""
...
def load_split():
    ...
    if not TRAIN_PATH.exists():
        raise FileNotFoundError(
            ...
            f"    python -m backend.ml.drinks.training.wine.build_wine_split"
        )
